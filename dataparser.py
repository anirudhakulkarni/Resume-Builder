#!c:\users\91930\appdata\local\programs\python\python38\python.exe
import sys
import time
...
for filename in os.listdir("E:\\ResumeBuilding ML\\CV-all\\CVs Batch of 2017 IITDelhi"):
    if(filename[-4::]==".pdf" or filename[-4::]==".PDF"):
        print(filename)
        try:
            func(['C:\\Users\\91930\\AppData\\Local\\Programs\\Python\\Python38\\Scripts\\pdf2txt.py', '-o', str(filename)[:-4]+".txt", filename])
        except:
            continue